# Terms of Service
## General
Please read these Terms and Conditions (“Terms“, “Terms and Conditions“) carefully before using the mobile app (the “Service“) created by Work Life (“us“, “we“, or “our“). 
...
and the contents of the offering, belong to WorkLife, WorkLife’s licensors or suppliers (“Intellectual Property“). 
...
Our Service may contain links to third-party web sites or services that are not owned or controlled by WorkLife.

WorkLife has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third-party web sites or services. 
You further acknowledge and agree that WorkLife shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by 
...
WorkLife, its licensors and / or suppliers retain ownership of the App (and any copy of the App). Standard data traffic rates may apply when using the App. 
...
(i) You agree that the terms of this paragraph apply between you and WorkLife (not with Apple Inc).

(ii) You hereby undertake to use the WorkLife’s iOS App solely in accordance with Apple Inc’s (“Apple“) at any time applicable terms of the App Store.

(iii) WorkLife, and not Apple, is solely responsible for WorkLife’s iOS App as well as the Service and Offering available therein. 
You understand that Apple has no obligation or liability to you with respect to the WorkLife’s iOS App or this Agreement.

(iv) WorkLife, and not Apple, is solely responsible for and manages any and all claims regarding WorkLife’s iOS App or your possession of and / or use 
of the WorkLife's iOS App in accordance with this Agreement.

(v) WorkLife, and not Apple, is also responsible for any third party claims regarding intellectual property infringement attributable to the WorkLife’s iOS App 
and your possession of or use of the WorkLife's iOS App.

Android App

This section sets out the specific terms and conditions of the use of the App on Android-based mobile devices (the “WorkLife’s Android App“) a
nd applies between you and WorkLife:

(i) Google Inc (“Google“) provides Google Play, where you download the WorkLife’s Android App.

(ii) You hereby undertake to use the WorkLife’s Android App solely in accordance with Google’s applicable terms of Google Play.

(iii) WorkLife, and not Google, is solely responsible for WorkLife’s Android App and the Services and Services available therein. 
Google has no obligation or liability to you with respect to WorkLife’s Android App or this Agreement.

## Limitation of Liability 
In no event shall WorkLife, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, 

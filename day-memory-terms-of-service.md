# Terms of Service
## General
Please read these Terms and Conditions (“Terms“, “Terms and Conditions“) carefully before using the mobile app (the “Service“) created by Andrey Kuzmenko (“DayMemory”, “us“, “we“, or “our“). 
...
and the contents of the offering, belong to DayMemory, DayMemory’s licensors or suppliers (“Intellectual Property“). 
...
Ownership of all Content belongs to you, or the third party who has the intellectual property rights to such Uploaded Material. 
...
Our Service may contain links to third-party web sites or services that are not owned or controlled by DayMemory.

DayMemory has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third-party web sites or services. 
You further acknowledge and agree that DayMemory shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by 
...
available at https://andreykuzmenko.github.io/apps/day-memory-privacy-policy.
...
DayMemory, its licensors and / or suppliers retain ownership of the App (and any copy of the App). Standard data traffic rates may apply when using the App. 
...
(i) You agree that the terms of this paragraph apply between you and DayMemory (not with Apple Inc).

(ii) You hereby undertake to use the DayMemory’s iOS App solely in accordance with Apple Inc’s (“Apple“) at any time applicable terms of the App Store.

(iii) DayMemory, and not Apple, is solely responsible for DayMemory’s iOS App as well as the Service and Offering available therein. 
You understand that Apple has no obligation or liability to you with respect to the DayMemory’s iOS App or this Agreement.

(iv) DayMemory, and not Apple, is solely responsible for and manages any and all claims regarding DayMemory’s iOS App or your possession of and / or use 
of the DayMemory's iOS App in accordance with this Agreement.

(v) DayMemory, and not Apple, is also responsible for any third party claims regarding intellectual property infringement attributable to the DayMemory’s iOS App 
and your possession of or use of the DayMemory's iOS App.

Android App

This section sets out the specific terms and conditions of the use of the App on Android-based mobile devices (the “DayMemory’s Android App“) a
nd applies between you and DayMemory:

(i) Google Inc (“Google“) provides Google Play, where you download the DayMemory’s Android App.

(ii) You hereby undertake to use the DayMemory’s Android App solely in accordance with Google’s applicable terms of Google Play.

(iii) DayMemory, and not Google, is solely responsible for DayMemory’s Android App and the Services and Services available therein. 
Google has no obligation or liability to you with respect to LeadcDayMemoryase’s Android App or this Agreement.

## Limitation of Liability 
In no event shall DayMemory, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, 
...
https://andreykuzmenko.github.io/apps/day-memory-terms-of-service. If your consent is required because of the changes, we will provide you with further notice as appropriate depending on the circumstances, and request your consent in accordance with the applicable data protection regulations.
